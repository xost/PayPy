...
class Model(object):
  ...
  def __init__(self):
    ...
    self.readonly=[['rur','outbal'],['rur','outgofix'],['rur','incomtotal'],['rur','outclients'],['rur','outclients2'],['rur','outgoplan'],['rur','outgoplan2']]
    ...
    self.outgoplan={'add':[['out'],['plan'],['outclients']]}
    self.outgoplan2={'add':[['outgo2'],['plan2']]}
